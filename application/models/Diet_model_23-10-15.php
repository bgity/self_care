...
class Diet_model extends CI_Model {
	...
	public function addPlan() {
		...
		if($post['planid']>0 && $post['copy_plan']==0)
		{
			...
			if(isset($post['target_weight_in_kg']))
			    $arr_planProfile['target_weight_in_kg'] = $post['target_weight_in_kg'];
		    else
				$arr_planProfile['target_weight_in_kg']='';
			
			$arr_planProfile['started_fat'] = $post['started_fat'];
			$arr_planProfile['target_fat'] = $post['target_fat'];
			$arr_planProfile['fat_ideal_range'] = $post['fat_ideal_range'];
