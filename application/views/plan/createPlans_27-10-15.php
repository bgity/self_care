...
<div class="text-center" ng-show="plan_opt">
    <h3>Diet Plan</h3>
	<a class="btn btn-xs yellow-gold pull-right" style="margin-bottom:10px;" ng-click="showGuidelines(formData.diseases)">Guidelines</a>
	<div class="col-md-3">
	...
	<div class="col-md-9">
		...
		<div class="row" ng-if="ex_user>0" ng-repeat="(ky,meal_opt) in  mealopts ">	
			
			<div class="col-md-12" style="outline:1px solid #7ca7cc; margin-bottom:10px;">
				...
				<div  ng-repeat="(key,value) in filteredopt = meal_opt.options track by $index">
					...
					<div class="text-left ng-scope" id="row{{ky}}_{{key}}"><label>Option:&nbsp;</label>
					
						 <span ng-repeat = "(kk,items) in itemsop = value track by $index" id="col{{ky}}_{{key}}_{{$index}}">
						   ...
						   <a ng-click='delOpItem(ky,key,$index)' ng-if="$index>0"><i class='fa fa-times'></i></a>
					   ...
					   <a class='btn btn-xs blue pull-right' ng-click="delOpt(ky,key)" ng-if="key>0"><i class='fa fa-times'>Del</i></a>
					   <div class='clearfix'>&nbsp;</div>
		...
		<div class="row" ng-if="ex_user==0" ng-repeat="diet_meal in filtered = ( checkedIndexs | orderBy )">
			<div class="col-md-12" style="outline:1px solid #7ca7cc; margin-bottom:10px;">
				...
				<hr class="dotted" style="margin:5px 0;">
				<div class="text-left optioncl"><label>Option:&nbsp;</label>
					<input type="text" class="form-control input-inline input-small" 
