<div class="text-center">
    <h3 class="text-center main_head">Schedule Exercise</h3>
	
	<div class="col-md-12">
			 <div class="col-md-3 form-horizontal blockwise">
				<div class="form-body">
			 ...
			 <div class="col-md-8 blockwise padding_zero" ng-repeat="(key,value) in formData.exercise_new " style="outline:1px solid #7ca7cc; margin-bottom:10px;float:right;">
				
				<h4>
					<img src="assets/admin/layout/img/morning.png" height="20" style="margin-right:10px;" ng-if="exercise_options[key-1].name=='Morning'" />
					<img src="assets/admin/layout/img/afternoon.png" height="20" style="margin-right:10px;" ng-if="exercise_options[key-1].name=='Afternoon'"  />
					<img src="assets/admin/layout/img/evening.png" height="20" style="margin-right:10px;" ng-if="exercise_options[key-1].name=='Evening'"  />
					<img src="assets/admin/layout/img/late_evening.png" height="20" style="margin-right:10px;" ng-if="exercise_options[key-1].name=='Late Evening'"  />
					{{exercise_options[key-1].name}}
				</h4>
				<div class="form-group">
					<table class="table table-bordered table-striped table-condensed flip-content" style="border-bottom:none !important;">
								...
								<td colspan="4" class="text-left"><a type="button" class="btn btn-xs green" ng-click="addExerciseOption(formData, key,excount)">Add Option<i class="fa fa-plus"></i></a></td>
										 ...
										 <tr ng-repeat="exercise in value.items track by $index">
											...
											<td width="15%">
												...
												<a ng-if="$index>0" type="button" class="btn btn-danger" ng-click="formData.exercise_new[key].items.splice($index, 1);">Del <i class="fa fa-times"></i></a>
											</td>
										</tr>
										
										<tr>
											<td colspan="4" class="text-left" style="border-bottom:none !important;"><a type="button" class="btn btn-success" ng-click="addExercise(formData, key)">Add<i class="fa fa-plus"></i></a></td>
										</tr>
			 ...
			 <!-- start anytime -->
			                <div class="col-md-8 blockwise padding_zero" style="outline:1px solid #7ca7cc; margin-bottom:10px;float:right;">
								<h4><img src="assets/admin/layout/img/all_time.png" height="20" style="margin-right:10px;" />Anytime</h4>
									...
									<table class="table table-bordered table-striped table-condensed flip-content">
										...
										<tbody>
											<tr ng-repeat="exercise_any in resultValue = (formData.exercise_anytime) track by $index">
												...
												<td width="15%">
													<a ng-if="$index>0" type="button" class="btn btn-danger" ng-click="formData.exercise_anytime.splice($index, 1);">Del<i class="fa fa-times"></i></a>
												</td>
												
											</tr>
											<tr>
												<td colspan="4" class="text-left"><a type="button" class="btn btn-success" ng-click="addExerciseAny(formData)">Add<i class="fa fa-plus"></i></a></td>
											</tr>
										</tbody>
									</table>
				            </div>
